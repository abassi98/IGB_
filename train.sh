...
conda activate igb
n_proc=$((${8}*${9}*${11}))
mpirun -np $n_proc python main.py --max_depth=$1 --width=$2 --act_func=$3 --Vw_max=$4 --Vw_min=$5 --Vb_max=$6 --Vb_min=$7 --n_w=$8 --n_b=$9 --n_net_samples=${10} --n_net_processes=${11} --n_data_samples=${12}
